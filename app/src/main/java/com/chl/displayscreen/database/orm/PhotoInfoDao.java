package com.chl.displayscreen.database.orm;
...
public class PhotoInfoDao extends AbstractDao<PhotoInfo, Long> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PHOTO_INFO\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"MODIFIED_DATE\" INTEGER," + // 2: modifiedDate
    ...
    protected final void bindValues(DatabaseStatement stmt, PhotoInfo entity) {
        ...
        java.util.Date modifiedDate = entity.getModifiedDate();
        if (modifiedDate != null) {
            stmt.bindLong(3, modifiedDate.getTime());
        }
    ...
    public PhotoInfo readEntity(Cursor cursor, int offset) {
        PhotoInfo entity = new PhotoInfo( //
            ...
            cursor.isNull(offset + 2) ? null : new java.util.Date(cursor.getLong(offset + 2)), // modifiedDate
    ...
    public void readEntity(Cursor cursor, PhotoInfo entity, int offset) {
        ...
        entity.setModifiedDate(cursor.isNull(offset + 2) ? null : new java.util.Date(cursor.getLong(offset + 2)));
